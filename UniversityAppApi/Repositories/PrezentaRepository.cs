...
{
    public class PrezentaRepository : GenericRepository<PrezentaModel>
    {
        public PrezentaRepository(UniversityContext ctx) : base(ctx)
        {
        }

        public override async Task<List<PrezentaModel>> GetAllAsync()
        {
        ...
        public async Task<List<PrezentaModel>> GetAllBySubjectAsync(int id)
        {
            var items = await _dbSet
                .Include(a => a.Student)
                .Include(a => a.Subject)
        ...
        public override async Task<PrezentaModel> GetAsync(int id)
        {
